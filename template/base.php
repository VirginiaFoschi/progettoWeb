            ...
            <div class="col-12">
                <footer class="bg-white footer">
                    <ul class="nav nav-pills nav-fill">
                        <li class="nav-item">
                            <a class="nav-link active" title="bacheca" href="bacheca.php" onclick="cambiaTab(this)">
                            ...
                            <li class="nav-item">
                            <a class="nav-link" title="cerca" href="search.php" onclick="cambiaTab(this)">
                            ...
                            <li class="nav-item">
                            <a class="nav-link" title="profilo" href="profilo.html" onclick="cambiaTab(this)">
