                ...
                <section class="px-3 mb-4">
                    ...
                    <ul>
                        ...
                        <li class="ml-3">
                            ...
                            <a href="<?php if($post["username"] === $_SESSION["username"]): echo "profilo-post.php"; else: echo "account-post.php";endif;?>?id=<?php echo $post["username"];?>"><?php echo $post["username"]; ?></a>
                                <p>Mi piace molto questo cosoooooooooooooooooooooooooooooooooooooooooooooooooooooooooo</p>
                                <a href="account.html">Utente autore evento</a>
                                <p>Mi piace molto questo coso</p>
                                <a href="account.html">Utente autore evento</a>
                                <p>Mi piace molto questo coso</p>
                                <a href="account.html">Utente autore evento</a>
                                <p>Mi piace molto questo coso</p>
                        ...
                        <li>
                            <form action="#" method="POST" id="form-commento">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <div class="col-12 text-end">
                                        <input id="backbtn" type="submit" class="btn btn-sm btn-outline-primary" value="Pubblica">
                                    </div>
                                </div>
                            </form>
                        </li>
