    ...
    <?php if (isset($post["Evento"]) && array_key_exists('id_evento', $post["Evento"])): ?>
        <div class="row justify-content-center content">
            ...
            <article class="article-annuncio bg-body border mb-3">
                    ...
                    <ul>
                        <li>
                            <span>
                                ...
                                <?php echo $post["Evento"]["Data_Evento"] ?>
                            </span>
                        </li>
                        <li>
                            <span>
                            ...
                            <div class="scroll-container smooth-scroll">
                                <?php foreach ($templateparams["commenti"] as $commento): ?>
                                    <?php if ($commento["ID_Evento"] === $post["Evento"]["id_evento"]): ?>
                                        <div class="border">
                                            <a href="<?php if($commento["Autore_Commento"] === $templateparams["nome-profilo"]): echo "profilo-post.php"; else: echo "account-post.php";endif;?>?id=<?php echo $commento["Autore_Commento"];?>"><?php echo $commento["Autore_Commento"]; ?>
                                            </a>
                                            <p>
                        ...
                        <li>
                            <form action="#" method="POST" class="form-commento">
                                <div class="mb-3">
                                    <label for="exampleFormControlTextarea1">Inserisci Commento</label>
                                    <textarea class="form-control" id="exampleFormControlTextarea1" cols="50"></textarea>
                                </div>
                                <div class="mb-3">
                                    <div class="col-12 text-end">
                                        <input id="backbtn" type="submit" class="btn btn-sm btn-outline-primary"
                                            value="Pubblica">
                                    </div>
                                </div>
                            </form>
                ...
                <footer>
                    <svg xmlns="http://www.w3.org/2000/svg" class="bi bi-chat comment-icon" viewBox="0 0 16 16" id="prova">
                        <path
