<header>
    <form action="#" method="POST">
        ...
        <input id="cerca" class="<?php if($_SESSION["text"] != ""): echo 'restore'; endif; ?>" type="text" placeholder="<?php echo $_SESSION["text"] == "" ? 'Search..' :  $_SESSION["text"]; ?>" name="search" title="searchbtn">
...
<ul class="nav justify-content-center bg-light" id="options">
    ...
    <li class="nav-item">
        <a class="nav-link <?php echo ($sottopagina == 'posts') ? 'active3' : ''; ?>" href="search-posts.php" onclick="cambiaTab3(this)">Posts</a>
    </li>
</ul>
