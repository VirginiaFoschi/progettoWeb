            ...
            <article class="article-annuncio bg-body border mb-3">
                    ...
                    <ul>
                            ...
                            <div class="scroll-container smooth-scroll">
                                <?php foreach ($templateparams["commenti"] as $commento): ?>
                                    <?php if ($commento["ID_Evento"] === $post["Evento"]["id_evento"]): ?>
                                        <div class="border">
                                            <a
                                                href="<?php if ($commento["Autore_Commento"] === $templateparams["nome-profilo"]):
                        ...
                        <li>
                            <form action="#" method="POST" class="form-commento"
                                ...
                                <div class="mb-3">
                                    <label for="text<?php echo $post["Evento"]["id_evento"]; ?>">Inserisci Commento</label>
                                    <textarea class="form-control" id="text<?php echo $post["Evento"]["id_evento"]; ?>" name="commento" cols="50"></textarea>
                ...
                <footer>
                    <svg xmlns="http://www.w3.org/2000/svg" class="bi bi-chat comment-icon" viewBox="0 0 16 16"
                        data-target="commento<?php echo $post["Evento"]["id_evento"]; ?>">
                        <path
