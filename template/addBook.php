            ...
            <div>
                ...
                <ul>
                    <li>
                        ...
                        <select class="form-select " id="floatingSelectCondizioni" aria-label="Floating label select example" name="condizioni">
                    ...
                    <li>
                        ...
                        <select class="form-select " id="floatingSelectGenere" aria-label="Floating label select example" name="genere">
