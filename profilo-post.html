<div class="row justify-content-center content">
    ...
    <article class="article-annuncio bg-body border mb-3">
        ...
        <header class="row">
            <a href="#">
                <img src="img/immagineProfilo.png" alt="Foto profilo" class="img-post">
                Utente Autore
            </a>
        </header>
        <section class="px-3 mb-4">
            ...
            <ul>
                ...
                <li>
                    <p id="descrizione-annuncio">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore
                        aperiam,
                        facilis iusto accusantium, veniam eos eligendi laboriosam magnam assumenda quibusdam placeat
                        illum
                        esse
                        dolores. Ullam molestias exercitationem consequuntur enim a?</p>
                </li>
            </ul>
        </section>
        <footer>
            ...
            <ul>
                <li>
                    <div class="d-flex align-items-center">
                        <img src="img/html5-js-css3.png" alt="Copertina libro" class="image" />
                        <ul>
                            <li>
                                <h2>Titolo Libro</h2>
                            </li>
                ...
                <li>
                    <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Natus assumenda porro, accusantium
                        aliquid
                        modi culpa quae corporis nesciunt, et soluta officiis fugiat ea minima repellat, quisquam
                        expedita
                        tempore ab mollitia.</p>
                </li>
            </ul>
        </section>
        <footer>
